...
precompile(Tuple{Type{Broadcast.Broadcasted{Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(:(==)), Tuple{Array{Float64, 1}, PyArray{Float64, 1}}})
precompile(Tuple{Type{Broadcast.Broadcasted{Broadcast.DefaultArrayStyle{1}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(pyincref), Tuple{PyArray{Ptr{PyObject_struct}, 1}}})
precompile(Tuple{Type{Broadcast.Broadcasted{Broadcast.DefaultArrayStyle{2}, Axes, F, Args} where Args<:Tuple where F where Axes}, typeof(pyincref), Tuple{PyArray{Ptr{PyObject_struct}, 2}}})
...
precompile(Tuple{Type{PyArray_Info{Bool, 1}}, Bool, Tuple{Int64}, Tuple{Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Bool, 3}}, Bool, Tuple{Int64, Int64, Int64}, Tuple{Int64, Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Complex{Float64}, 2}}, Bool, Tuple{Int64, Int64}, Tuple{Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Float16, 1}}, Bool, Tuple{Int64}, Tuple{Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Float16, 2}}, Bool, Tuple{Int64, Int64}, Tuple{Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
...
precompile(Tuple{Type{PyArray_Info{Float64, 1}}, Bool, Tuple{Int64}, Tuple{Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Float64, 2}}, Bool, Tuple{Int64, Int64}, Tuple{Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Float64, 3}}, Bool, Tuple{Int64, Int64, Int64}, Tuple{Int64, Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Int16, 1}}, Bool, Tuple{Int64}, Tuple{Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Int32, 1}}, Bool, Tuple{Int64}, Tuple{Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Int32, 2}}, Bool, Tuple{Int64, Int64}, Tuple{Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Int64, 0}}, Bool, Tuple{}, Tuple{}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Int64, 1}}, Bool, Tuple{Int64}, Tuple{Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Int64, 2}}, Bool, Tuple{Int64, Int64}, Tuple{Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Int64, 3}}, Bool, Tuple{Int64, Int64, Int64}, Tuple{Int64, Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Ptr{Nothing}, 0}}, Bool, Tuple{}, Tuple{}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Ptr{PyObject_struct}, 1}}, Bool, Tuple{Int64}, Tuple{Int64}, Ptr{Nothing}, Bool, PyBuffer})
precompile(Tuple{Type{PyArray_Info{Ptr{PyObject_struct}, 2}}, Bool, Tuple{Int64, Int64}, Tuple{Int64, Int64}, Ptr{Nothing}, Bool, PyBuffer})
...
precompile(Tuple{Type{Py_buffer}, Ptr{Nothing}, Ptr{PyObject_struct}, Int64, Int64, Int64, Int64, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}})
...
precompile(Tuple{typeof(Base.literal_pow), typeof(:(^)), PyObject, Val{-1}})
precompile(Tuple{typeof(Base.literal_pow), typeof(:(^)), PyObject, Val{0}})
precompile(Tuple{typeof(Base.literal_pow), typeof(:(^)), PyObject, Val{4}})
precompile(Tuple{typeof(Base.vect), PyObject, Vararg{PyObject}})
precompile(Tuple{typeof(Base.vect), PyObject})
precompile(Tuple{typeof(Broadcast.broadcasted), Broadcast.DefaultArrayStyle{1}, Function, Base.RefValue{PyObject}, Array{Int64, 1}})
...
precompile(Tuple{typeof(Broadcast.materialize), Broadcast.Broadcasted{Broadcast.DefaultArrayStyle{1}, Nothing, typeof(:(==)), Tuple{Array{Float64, 1}, PyArray{Float64, 1}}}})
precompile(Tuple{typeof(Broadcast.materialize), Broadcast.Broadcasted{Broadcast.DefaultArrayStyle{1}, Nothing, typeof(pyincref), Tuple{PyArray{Ptr{PyObject_struct}, 1}}}})
precompile(Tuple{typeof(Broadcast.materialize), Broadcast.Broadcasted{Broadcast.DefaultArrayStyle{2}, Nothing, typeof(pyincref), Tuple{PyArray{Ptr{PyObject_struct}, 2}}}})
...
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{Array{Float64, 2}, String}, Base.Pairs{Symbol, String, Tuple{Symbol}, NamedTuple{(:order,), Tuple{String}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{Array{Int64, 1}, Int64}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{Int64, Int64, Int64}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{Int64, Int64}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{Int64}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{PyObject, Nothing, Nothing, Nothing}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{PyObject, PyObject}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{PyObject}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{String, Int64, Float64}, Base.Pairs{Symbol, Any, Tuple{Symbol, Symbol}, NamedTuple{(:b, :c), Tuple{Int64, String}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{String, Int64, Float64}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{String, String}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{String, Tuple{PyObject, PyObject}, Dict{Any, Any}}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{String, Tuple{PyObject}, Dict{Any, Any}}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{String}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pycall!), PyObject, PyObject, Tuple{UnitRange{Int64}, UnitRange{Int64}, UnitRange{Int64}}, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}})
precompile(Tuple{typeof(_pyjlwrap_call), FuncWrapper{Tuple{Complex{Int64}}, typeof(sin)}, Ptr{PyObject_struct}, Ptr{PyObject_struct}})
precompile(Tuple{typeof(_pyjlwrap_call), FuncWrapper{Tuple{Int64}, typeof(factorial)}, Ptr{PyObject_struct}, Ptr{PyObject_struct}})
...
precompile(Tuple{typeof(iterate), PyDict{Int64, PyObject, false}, Tuple{PyObject, Nothing}})
precompile(Tuple{typeof(iterate), PyDict{Int64, PyObject, false}, Tuple{PyObject, Tuple{Tuple{Int64, PyObject}, Tuple{PyObject, PyObject}}}})
...
precompile(Tuple{typeof(pyany_toany), Core.TypeofVararg})
...
precompile(Tuple{typeof(pyfunctionret), Function, Type, Core.TypeofVararg})
