...
type PyDict{K,V} <: Associative{K,V}
    ...
    function PyDict(o::PyObject) 
        ...
        new(o, pyisinstance(o, @pyfunc :PyDict_Type))
    end
    function PyDict() 
        @pyinitialize
...
has(d::PyDict, key) = 1 == ccall(d.isdict ? (@pyfunc :PyDict_Contains)
                                          : (@pyfunc :PyMapping_HasKey),
...
function delete!(d::PyDict, k)
    v = d[k]
    @pycheckzi ccall(d.isdict ? (@pyfunc :PyDict_DelItem)
...
length(d::PyDict) = @pycheckz ccall(d.isdict ? (@pyfunc :PyDict_Size)
                                             : (@pyfunc :PyObject_Size), 
                                    Int, (PyPtr,), d)
...
pyint_query(o::PyObject) = pyisinstance(o, @pyfunc :PyInt_Type) ? 
  (pyisinstance(o, @pyfunc :PyBool_Type) ? Bool : Int) : None

pyfloat_query(o::PyObject) = pyisinstance(o, @pyfunc :PyFloat_Type) ? Float64 : None

pycomplex_query(o::PyObject) = 
  pyisinstance(o, @pyfunc :PyComplex_Type) ? Complex128 : None

pystring_query(o::PyObject) = pyisinstance(o, @pyfunc :PyString_Type) ? String : None

pyfunction_query(o::PyObject) = pyisinstance(o, @pyfunc :PyFunction_Type) || pyisinstance(o, BuiltinFunctionType) || pyisinstance(o, ufuncType) || pyisinstance(o, TypeType) || pyisinstance(o, MethodType) || pyisinstance(o, MethodWrapperType) ? Function : None
...
pydict_query(o::PyObject) = pyisinstance(o, @pyfunc :PyDict_Type) || (pyquery((@pyfunc :PyMapping_Check), o) && ccall((@pyfunc :PyObject_HasAttrString), Cint, (PyPtr,Array{Uint8}), o, "items") == 1) ? Dict{PyAny,PyAny} : None
...
function pysequence_query(o::PyObject)
    ...
    # problems
    if pyisinstance(o, @pyfunc :PyTuple_Type)
        ...
        try
            ...
            return pyisinstance(o, @pyfunc :PyList_Type) ? Vector{PyAny} : None
        end
    end
end
